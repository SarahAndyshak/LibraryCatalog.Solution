    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LibrarianId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    LibrarianName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UserId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookCatalogId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    BookId = table.Column<int>(type: "int", nullable: false),
                    CatalogId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCatalog", x => x.BookCatalogId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCheckouts_Checkouts_CheckoutId",
            ...
            migrationBuilder.CreateTable(
                name: "CatalogLibrarians",
                columns: table => new
                {
                    CatalogLibrarianId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    CatalogId = table.Column<int>(type: "int", nullable: false),
                    LibrarianId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CatalogLibrarians", x => x.CatalogLibrarianId);
                    table.ForeignKey(
                        name: "FK_CatalogLibrarians_Catalogs_CatalogId",
                        column: x => x.CatalogId,
                        principalTable: "Catalogs",
                        principalColumn: "CatalogId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CatalogLibrarians_Librarians_LibrarianId",
            ...
            migrationBuilder.CreateTable(
                name: "CheckoutPatrons",
                columns: table => new
                {
                    CheckoutPatronId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    CheckoutId = table.Column<int>(type: "int", nullable: false),
                    PatronId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CheckoutPatrons", x => x.CheckoutPatronId);
                    table.ForeignKey(
                        name: "FK_CheckoutPatrons_Checkouts_CheckoutId",
                        column: x => x.CheckoutId,
                        principalTable: "Checkouts",
                        principalColumn: "CheckoutId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CheckoutPatrons_Patrons_PatronId",
                        column: x => x.PatronId,
                        principalTable: "Patrons",
                        principalColumn: "PatronId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCheckouts_CheckoutId",
                table: "BookCheckouts",
                column: "CheckoutId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CatalogLibrarians_CatalogId",
                table: "CatalogLibrarians",
                column: "CatalogId");

            migrationBuilder.CreateIndex(
                name: "IX_CatalogLibrarians_LibrarianId",
                table: "CatalogLibrarians",
                column: "LibrarianId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CheckoutPatrons_CheckoutId",
                table: "CheckoutPatrons",
                column: "CheckoutId");

            migrationBuilder.CreateIndex(
                name: "IX_CheckoutPatrons_PatronId",
                table: "CheckoutPatrons",
                column: "PatronId");
